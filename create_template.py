...
def create_template():
    ...
    set_font(name_run, 'San Sefiro', 26, True, heading_color)
    
    slogan_para = doc.add_paragraph()
    slogan_run = slogan_para.add_run('{{slogan}}')
    set_font(slogan_run, 'San Sefiro', 20, True, heading_color)
    ...
    set_font(summary_run, 'San Sefiro', 11)
    doc.add_paragraph()
    ...
    set_font(expertise_run, 'San Sefiro', 11)
    doc.add_paragraph()
